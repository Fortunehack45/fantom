...
import { GhostIcon } from "./icons"; // Assuming you might want your logo here
import { Button } from "./ui/button";
import { Twitter, Youtube, Twitch } from 'lucide-react'; // Example icons
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
         ...
         <div className="mt-8 pt-6 border-t border-primary/10 text-center text-sm text-muted-foreground flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p>Developed By <Link href="#" className="font-semibold text-primary hover:underline">Fourtuna</Link></p>
        </div>
      </div>
    </footer>
  );
